...
def add_profile():
    ...
    if not name_entered:
        ...
        new_profile_name.place(x=20, y=170)
        enter_name = tkinter.Button(root, text = "Enter Name", command = add_profile).place(x=20, y=140)
        name_entered = True
    else:
...
submit_button = tkinter.Button(root, text = "Submit", command = submit).place(x=425, y=450)
#load_profile_button = tkinter.Button(root, text = "Load Profile", command = load_profile).place(x=20, y=60)
save_profile_button = tkinter.Button(root, text = "Save Profile", command = save_profile).place(x=20, y=60)
add_profile_button = tkinter.Button(root, text = "Add Profile", command = add_profile).place(x=20, y=100)
